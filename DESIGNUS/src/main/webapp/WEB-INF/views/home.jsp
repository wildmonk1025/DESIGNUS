...
<body>
	...
	<div id="middle">
		<div id="middle_content1">
			<div id="middle_content1_title" style="background-color: #eba993;">&nbsp;추천
				출품작</div>
			<div id="middle_content1_lv1">
				<div id="middle_content1_lv2">
					<c:forEach var="rl" items="${recommList}">
						<div class="recommlist"
							onclick="javascript:location.href='auctionRead?au_num=${rl.au_num}'">
							<div class="recomm_img">
								<img src="/auction/${rl.aui_img}" width="100%" height="100%" />
							</div>
							<div class="recomm_text">
								<p class="titlestyle">${rl.au_title}</p>
								<p style="font-size: 17px;">구매가:${rl.au_inprice}원</p>
							</div>
						</div>
					</c:forEach>
				</div>
		...
		<div id="middle_content2">
			<div id="middle_content2_title" style="background-color: #eba993;">&nbsp;진행중인
				추천 제작의뢰</div>
			<div id="middle_content2_lv1">
				<div id="middle_content2_lv2">
					<c:forEach var="rl2" items="${recommList_ra}">
						<div class="recommlist2"
							onclick="javascript:location.href='revauctionread?ra_num=${rl2.ra_num}'">
							<div class="recomm_img2">
								<img src="/revauction/${rl2.ra_image}" width="100%"
									height="100%" />
							</div>
							<c:if test="${rl2.rat_price != 0}">
								<div class="recomm_text2">
									<p class="titlestyle">${rl2.ra_title}</p>
									<p style="font-size: 17px;">의뢰접수 최저가:${rl2.rat_price}원</p>
								</div>
							</c:if>
							<c:if test="${rl2.rat_price == 0}">
								<div class="recomm_text2">
									<p class="titlestyle">${rl2.ra_title}</p>
									<p style="font-size: 17px;">의뢰접수 최저가: -</p>
								</div>
							</c:if>
						</div>
					</c:forEach>
		...
		<div id="middle_content3">
			<div id="middle_content3_title" style="background-color: #eba993;">&nbsp;관심
				후원</div>
			<div id="middle_content3_lv1">
				<div id="middle_content3_lv2">
					<c:forEach var="rl3" items="${recommList_ss}">
						<div class="recommlist3"
							onclick="javascript:location.href='sponproduct?ss_num=${rl3.ss_num}'">
							<div class="recomm_img3">
								<img src="/sponsor/${rl3.ssi_img}" width="100%" height="100%" />
							</div>
							<div class="recomm_text3">
								<p class="titlestyle">${rl3.ss_title}</p>
								<p style="font-size: 17px;">후원 진행상황: ${rl3.ss_curPercent} %</p>
							</div>
						</div>
					</c:forEach>
				</div>
