...
<script type="text/javascript">
	...
	for (var i = 0; i < apwList.length; i++) {
		...
		main += "<table><tr rowspan=4><td><a href='imgAuction'><img src='/resources/images/"+apwList[i].aui_img+"'/></a>"
				+ "<tr><td>상품번호 :"
				+ apwList[i].aup_ptnum
				+ "</td><td>상품명:"
				+ apwList[i].au_title
		...
		if (apwList[i].aup_step === 1) {
			main = +"<tr><td colspan='2'><p>작업이 확정된 시점의 요청사항 추가는 추가 요금 및,<br/> 작업 완료일이 늘어날 수 있습니다.</td></tr>"
			    ...
			    +"<tr><td colspan='3'><input type='button' onclick=\"shopping('"+apwList[i].aup_ptnum+"')\" value='배송보내기'/>"
