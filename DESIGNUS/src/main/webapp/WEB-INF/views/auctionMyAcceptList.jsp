...
<head>
    ...
    <style type="text/css">
        ...
        a:hover{text-decoration: none;color:#646464;}       #header {
	padding: 3px;
	width: 1510px;
	height: 100px;
	float: left;
...
<body>
	...
	<div id="category">
		...
		<div id="menu">
            ...
            <div id="auction">
                ...
                <div class="bt01">
                    ...
                    <button id="cancel">배송 보내기</button></div>
            </div>
            <div id="spon">
                <h1>배송정보</h1>
                <div class="bt01">
     ...
     <h1>의뢰인배송정보</h1>
            <button>확인</button>
            <button type="button" onclick="location.href='auctionMyAcceptList.html' ">취소</button>
    </div>
    </div>       
