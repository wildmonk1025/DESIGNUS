			...
			<form action="sponupload" name="sponwriter" method="post"
				...
				<table id="tableCont" border="1" style="text-align: center">
					<tr style="height: 50">
						...
						<td colspan="3"><input type="text" id="ss_title" name="ss_title"></td>
					</tr>
					<tr style="height: 50">
						<td>가격</td>
						<td style="width: 400"><input id="ss_price" name="ss_price" type="number"
							style="width: 100%"></td>
						<td style="width: 100">목표주문량</td>
						<td style="width: 400"><input id="ss_goalqty" name="ss_goalqty" type="number"
							style="width: 100%"></td>
					</tr>
					<tr style="height: 50">
						<td>이미지</td>
						<td colspan="3"><input type="file" id="imgInput" name="imgInput"
					...
					<tr style="height: 100">
						<td colspan="4" rowspan="2"><textarea id="ss_contents" name="ss_contents"
								style="width: 1000px; height: 140px; font-size: 17px; resize: none;" rows="20" cols="10"
								placeholder="상품 상세설명을 작성하세요."></textarea></td>
					</tr>
				</table>
				<div id="btn2">
