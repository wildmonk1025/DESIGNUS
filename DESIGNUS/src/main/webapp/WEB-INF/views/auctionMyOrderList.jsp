...
<body>
    <div id="one">
        ...
        <div id="info">
            <table width="1000">
                ...
                <tr>
                    <td style="font-size: 30px"><a href="">출품작 구매 내역</a></td>
                </tr>
                <tr>
    ...
    <div id="auction">
        ...
        <div class="bt01">
            ...
            <button id="cancel">물품취소하기</button></div>
    </div>
    <div id="spon">
        <h1>배송정보</h1>
        <div class="bt01">
    ...
    <div id="lightbox-shadow">
        ...
        <div id="lightbox">
            <h1>여기가 배송정보입력</h1>
            <button>요청</button>
            <button type="button" onclick="location.href='auctionMyOrderList.html' ">취소</button>
        </div>
    </div>
    <div id="lightbox-shadow1">
        ...
        <div id="lightbox1">
            <h1>출품작 낙찰취소</h1>
            <button>취소하기</button>
            <button type="button" onclick="location.href='auctionMyOrderList.html' ">돌아가기</button>
        </div>
    </div>
