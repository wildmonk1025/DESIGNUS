		...
		<div id="rightmain">
			...
			<div id="spon1">
				...
				<div id="list">
					<div id="ListView1">
						<div id="listdiv">
							<p align="center" style="font-size: 25px;">출품 꿍리스트</p>
						</div>
						<div id="cnavfn">
							<c:forEach var="board" items="${bList}">
								<a href='#' onclick="articleView(${board.ab_aunum})"> <img
									src='/resources/images/${board.aui_img}'></a>
								<P>상품 제목 : ${board.au_title}</P>
							</c:forEach>
						</div>
