			...
			<form action="login" name="loginFrm" method="post"class="signUp">
				<div id="login">
					<table id="idpw" align="center">
						<tr>
							<th>아이디</th>
							<th><input type="text" name="mb_id" id="mb_id" class="signUpInput" 
							placeholder="Type your user id" autofocus required /></th>
						</tr>
						<tr>
							<th>비밀번호</th>
							<th><input type="password" name="mb_pw" id="mb_pw" class="signUpInput"
