...
public class AjaxHomeControllerjy {
	...
	@RequestMapping(value = "/memberidfind", produces = "application/json;charset=utf-8")
	public String memberidfind(@RequestBody String email, String name, HttpServletResponse response) {
