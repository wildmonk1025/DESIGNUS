...
public class AjaxMypageController {
	 ...
	 * "/ajax/lbrev",produces="application/json;charset=utf8")
	 * 
	 * public Map<String, Object> lbrev(Integer pageNum ,String kind) {
	 * System.out.println("여기로 와라 제발..."); System.out.println("kind="+kind);
	 * Map<String, Object>rMap=pm.lbrev(pageNum,kind); return rMap;
	 * 
	 * }
	 * 
	 * @RequestMapping(value =
